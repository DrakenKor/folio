        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              This page showcases image processing using Rust based web assembly
              (WASM). Smaller images typically show a JS performance win,
              whereas larger images tend to show WASM performance wins.
            </p>
          </div>
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  ...
                  <li>
                    Separable filter implementations for better cache
                    performance
                  </li>
                </ul>
              </div>
