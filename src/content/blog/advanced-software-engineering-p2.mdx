...
description: "The schema, indexes, and read model quietly decide how much work each request creates. Shape the work, and the database follows."
date: "2026-05-12"
...
<Callout type="warning" title="Warning">
  A denormalized table is only complete when a rebuild job sits beside it. Derived data will eventually need repair, after bugs, retries, and schema changes, so give it a way to be repaired before you need one.
</Callout>
